...
bot = telebot.TeleBot('7101538144:AAH_-ZwUTRZdiBLm-WtiOKg4_K2xgL2L-Jk')
...
GROUP_ID = "-1002251102201"
CHANNEL_USERNAME = "@RAJPUTPAID"

# Default cooldown and attack limits
COOLDOWN_TIME = 5  # Cooldown in seconds
ATTACK_LIMIT = 10  # Max attacks 0per day
...
def handle_attack(message):
    ...
    full_command = f"./soul {target} {port} {time_duration}"
    ...
    try:
        ...
        if user_status not in ['member', 'administrator', 'creator']:
            bot.reply_to(message, f"❌ **𝐘𝐨𝐮 𝐌𝐔𝐒𝐓 𝐉𝐎𝐈𝐍 𝐎𝐔𝐑 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐅𝐈𝐑𝐒𝐓!**\n"
                                  f"🔗 **𝐉𝐨𝐢𝐧 𝐇𝐞𝐫𝐞:** [Click Here](https://t.me/+NYbRtL8swZZmNzM1{CHANNEL_USERNAME})")
            return  
...
👉 [𝙏𝙚𝙡𝙚𝙜𝙧𝙖𝙢 𝙂𝙧𝙤𝙪𝙥](https://t.me/+NYbRtL8swZZmNzM1) 🚀🔥"""
